...
#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_ANDROID) || BUILDFLAG(IS_QNX)
// NSIG is 64 on Linux (for real-time signals), 57 on QNX.
// The signal name table covers the standard 32 signals.
